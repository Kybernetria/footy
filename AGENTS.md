...
curl -o src-tauri/resources/models/silero_vad_v4.onnx https://blob.footy.local/silero_vad_v4.onnx
```

## Architecture Overview

Footy is a cross-platform desktop speech-to-text application built with Tauri (Rust backend + React/TypeScript frontend).
