; Custom NSIS template for Footy with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Footy for portable
...
Function PageReinstall
  ...
  ; and they can chose to abort it if it is not appropriate.
  StrCpy $0 0
  wix_loop:
...
Function .onInit
  ...
  ; or the legacy empty marker created by older portable releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Footy Portable Mode"
    FileClose $0
